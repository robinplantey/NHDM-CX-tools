...
(*Construct the potential from the bilinear couplins \[CapitalLambda],L,M,Subscript[\[CapitalLambda], 0],Subscript[M, 0]*)
...
(*Transformation of a set of bilinear couplings (\[CapitalLambda],L,M,Subscript[\[CapitalLambda], 0],Subscript[M, 0]) under a change of basis U*)
...
(* Main function: search for a subalgebra in a set of LM-orthogonal eigenvectors *)
